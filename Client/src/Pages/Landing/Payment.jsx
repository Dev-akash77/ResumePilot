...
const Payment = () => {
  ...
  // 2. Logic to Lock Scroll when Dialog is Open
  useEffect(() => {
  ...
  const handleSelectPlan = (plan) => {
    const {id,credits,price} = plan;
    dispatch(openPaymentDialogBox());
    dispatch(paymentSelection({id,credits,price}));
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 font-sans relative">
      <div className="max-w-6xl w-full">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 text-lg max-w-xl mx-auto">
            Choose the perfect credit pack for your career needs. No hidden
            fees.
          </p>
        </div>
      ...
      {/* ! DIALOG BOX - Conditional Rendering */}
      {payment.showDialog && (
